...
namespace Students_Group
{
    ...
    public class Student : IComparable
    {
        ...
        public int CompareTo(Object obj)
        {
            ...
            if (birthday.GetYear() > st.birthday.GetYear())
                return 1;
            if (birthday.GetMonth() > st.birthday.GetMonth())
                return 1;
            if (birthday.GetDay() > st.birthday.GetDay())
                return 1;
            if ((birthday.GetYear() == st.birthday.GetYear()) && (birthday.GetMonth() == st.birthday.GetMonth()) && (birthday.GetDay() == st.birthday.GetDay()))
                return 0;
            else return -1;
        }
